...
if not os.path.isdir(f'{dir_download}/dataset/labels'):
    os.makedirs(f'{dir_download}/dataset/labels')
...
for split in tqdm(split_list):
    ...
    if not os.path.isdir(f'{dir_download}/dataset/labels/{split}'):
        os.makedirs(f'{dir_download}/dataset/labels/{split}')
    ...
    for city in city_list:
        ...
        if not os.path.isdir(f'{dir_download}/dataset/labels/{split}/{city}'):
            os.makedirs(f'{dir_download}/dataset/labels/{split}/{city}')

        img_list = os.listdir(f'{dir_img}/{split}/{city}')
        img_list = sorted(img_list)

        for img in img_list:
            bev_image, bev_objects = bevconverter.get_BEV_image(f'{dir_img}/{split}/{city}/{img}')
        # for gtbbox in img_list:
        #     gtbbox_dir = f'{dir_img}/{split}/{city}/{gtbbox}'
